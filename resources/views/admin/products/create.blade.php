                ...
                <div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required class="w-full px-4 py-2 border border-bloom-accent-light rounded-lg focus:ring-2 focus:ring-bloom-primary focus:border-transparent">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="text" id="slug" name="slug" value="{{ old('slug') }}" required class="w-full px-4 py-2 border border-bloom-accent-light rounded-lg focus:ring-2 focus:ring-bloom-primary focus:border-transparent">
                            @error('slug')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" class="w-full px-4 py-2 border border-bloom-accent-light rounded-lg focus:ring-2 focus:ring-bloom-primary focus:border-transparent">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="price" name="price" value="{{ old('price') }}" required min="0" class="w-full px-4 py-2 border border-bloom-accent-light rounded-lg focus:ring-2 focus:ring-bloom-primary focus:border-transparent">
                            @error('price')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="stock" name="stock" value="{{ old('stock', 0) }}" required min="0" class="w-full px-4 py-2 border border-bloom-accent-light rounded-lg focus:ring-2 focus:ring-bloom-primary focus:border-transparent">
                            @error('stock')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
