            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-bloom-bg-cream/30 rounded-lg p-4 border border-bloom-accent-light">
                            ...
                            <ul class="list-disc list-inside text-gray-700 space-y-1">
                                ...
                                <li>Produk yang dilihat atau dibeli</li>
                                <li>Ulasan dan rating yang diberikan</li>
                            </ul>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <ul class="list-disc list-inside text-gray-700 space-y-2">
                        ...
                        <li>Mengirim konfirmasi dan notifikasi pesanan</li>
                ...
                <section>
                    ...
                    <ul class="list-disc list-inside text-gray-700 space-y-2">
                        ...
                        <li>Gateway pembayaran untuk memproses transaksi</li>
                ...
                <section>
                    ...
                    <ul class="list-disc list-inside text-gray-700 space-y-2">
                        ...
                        <li>Membatalkan langganan dari komunikasi pemasaran</li>
                    </ul>
                </section>
