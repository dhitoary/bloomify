    ...
    <div class="py-12 bg-bloom-bg-light min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                ...
                <p class="text-gray-600">Terakhir diperbarui: Mei 2026</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 space-y-8">
                ...
                <section>
                    ...
                    <div class="space-y-3 text-gray-700">
                        ...
                        <p>
                            Semua gambar produk adalah representasi dan mungkin tidak menampilkan kondisi produk yang sebenarnya. Ketersediaan produk terbatas dan dapat berubah sewaktu-waktu.
                        </p>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="space-y-3 text-gray-700">
                        ...
                        <p>
                            Pesanan dianggap diterima setelah Anda menerima email konfirmasi dari kami. Harga dapat berubah tanpa pemberitahuan, namun harga yang Anda lihat pada saat checkout adalah harga yang akan Anda bayar.
                        </p>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="space-y-3 text-gray-700">
                        ...
                        <p>
                            Anda bertanggung jawab untuk memberikan alamat pengiriman yang lengkap dan akurat. Kami tidak bertanggung jawab atas keterlambatan pengiriman karena informasi alamat yang tidak lengkap.
                        </p>
                        <p>
                            Bunga adalah produk yang mudah rusak. Kami akan berusaha sebaik mungkin untuk memastikan pengiriman dengan aman, namun kami tidak bertanggung jawab atas kerusakan yang terjadi selama pengiriman.
                        </p>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="space-y-3 text-gray-700">
                        ...
                        <p>
                            Semua pembayaran diproses melalui gateway pembayaran aman. Anda bertanggung jawab atas semua biaya penggunaan kartu kredit atau bank yang dikenakan oleh lembaga keuangan Anda.
                        </p>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div class="space-y-3 text-gray-700">
                        ...
                        <p>
                            Jika Anda menerima produk yang rusak atau tidak sesuai dengan pesanan, silakan hubungi kami dalam waktu 24 jam dengan bukti foto untuk diskusi lebih lanjut mengenai solusi terbaik.
                        </p>
                        <p>
                            Permintaan pengembalian dana harus diajukan dalam waktu 7 hari setelah penerimaan produk.
                        </p>
                    </div>
                </section>
