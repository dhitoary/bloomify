...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $products = [
            ...
            // Kategori 2: Buket Bunga Segar
            [
                'category_id' => 2, 'name' => 'Buket Snack / Jajanan Mahasiswa', 'slug' => 'buket-snack-jajanan-mahasiswa',
                'description' => 'Alternatif hemat yang sangat diminati.', 'price' => 75000, 'stock' => 30
            ],
            [
                'category_id' => 2, 'name' => 'Buket Uang (Jasa & Bunga Artificial)', 'slug' => 'buket-uang-jasa-bunga-artificial',
                'description' => 'Harga jasa merangkai, belum termasuk nominal uang tunai di dalamnya.', 'price' => 100000, 'stock' => 20
            ],
            [
                'category_id' => 2, 'name' => 'Buket Bunga + Boneka Wisuda', 'slug' => 'buket-bunga-boneka-wisuda',
                'description' => 'Paket kado lengkap untuk merayakan kelulusan.', 'price' => 150000, 'stock' => 15
            ],
            [
                'category_id' => 2, 'name' => 'Bloom Box Mini + Balon Custom', 'slug' => 'bloom-box-mini-balon-custom',
                'description' => 'Kotak bunga dengan balon transparan berisi tulisan.', 'price' => 185000, 'stock' => 10
            ],
            [
                'category_id' => 2, 'name' => 'Box Bunga Mawar + Cokelat Bar', 'slug' => 'box-bunga-mawar-cokelat-bar',
